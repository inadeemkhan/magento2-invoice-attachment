...
use Nadeem\PdfFileAttachment\Api\Data\InvoiceAttachmentSearchResultsInterfaceFactory;
use Nadeem\PdfFileAttachment\Api\InvoiceAttachmentRepositoryInterface;
use Nadeem\PdfFileAttachment\Model\ResourceModel\InvoiceAttachment as ResourceInvoiceAttachment;
use Nadeem\PdfFileAttachment\Model\ResourceModel\InvoiceAttachment\CollectionFactory as InvoiceAttachmentCollectionFactory;
...
class InvoiceAttachmentRepository implements InvoiceAttachmentRepositoryInterface
{
    ...
    public function save(
        ...
        $invoiceAttachmentData = $this->extensibleDataObjectConverter->toNestedArray(
            $invoiceAttachment,
            [],
            \Nadeem\PdfFileAttachment\Api\Data\InvoiceAttachmentInterface::class
        );
